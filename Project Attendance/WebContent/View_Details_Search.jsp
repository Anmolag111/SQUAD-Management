			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
						...
						<div class="clear"></div><div class="line"></div>
								...
								<form id="register-form" name="register-form" class="nobottommargin" action="View_Leave_Details" method="post">					
											...
											<div class="row">
													...
													<div class="col-md-6">
														...
														<input type="date" id="register-form-phone" name="StartDate"  class="form-control" />
													</div>


													<div class="col-md-6">
														<label for="register-form-phone">End Date:</label>
														<input type="date" id="register-form-phone" name="EndDate"  class="form-control" />
													</div>
											...
											<div class="col_full nobottommargin center">
												 <button type="submit" form="register-form" class="button button-border button-rounded button-fill fill-from-bottom button-black"><i class="fas fa-search"></i><span>Search</span></button>
											</div>
								</form>	
