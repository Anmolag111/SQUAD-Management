				...
				<div class="container clearfix">
					...
					<div class="tabs divcenter nobottommargin clearfix" id="tab-login-register" style="max-width: 500px;">
						...
						<div class="tab-container">
							...
							<span style="color:red"><%=(request.getAttribute("successMessageUpdate") == null) ? "" : request.getAttribute("successMessageUpdate")%></span>
							<span style="color:red"><%=(request.getAttribute("errorMessageUpdate") == null) ? "" : request.getAttribute("errorMessageUpdate")%></span>
							<span style="color:red"><%=(request.getAttribute("errorMessageUpdateEid") == null) ? "" : request.getAttribute("errorMessageUpdateEid")%></span>
							<span style="color:red"><%=(request.getAttribute("errorMessageDuplicate") == null) ? "" : request.getAttribute("errorMessageDuplicate")%></span>
							<span style="color:red"><%=(request.getAttribute("errorMessageMedical") == null) ? "" : request.getAttribute("errorMessageMedical")%></span>
							<span style="color:red"><%=(request.getAttribute("errorMessagePending") == null) ? "" : request.getAttribute("errorMessagePending")%></span>
							...
							<div class="tab-content clearfix" id="tab-register">
								<div class="card nobottommargin">
									<div class="card-body" style="padding: 40px;">
										...
										<form id="register-form" name="register-form" class="nobottommargin" action="Update_Leaves_User" method="post">
											...
											<div class="col_full">
												...
												<label>Yes<input type="radio" id="register-form-phone" name="leaveProvided" value="LP_YES" class="form-control"  checked/></label>
												&nbsp;
												&nbsp;
												<label>No<input type="radio" id="register-form-phone" name="leaveProvided" value="LP_NO" class="form-control"  /></label>
											...
											<div id="seeHALF_DAY" class="Duration">
												...
												<div class="col_full">
												    ...
												    <input type="time" id="register-form-phone" name="start_time_HALFDAY"  class="form-control"  />
												</div>
												
												<div class="col_full">
													<label for="register-form-phone">End Time:</label>
												    <input type="time" id="register-form-phone" name="end_time_HALFDAY"  class="form-control"  />
												</div>
											...
											<div class="col_full nobottommargin">
												 ...
												 <button type="submit" form="register-form" class="button button-border button-rounded button-fill fill-from-bottom button-black"><i class="fas fa-user-edit"></i><span> Update Employee</span></button>
											</div>
