		...
		<header id="header" class="full-header" style="height: 100px;" >
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.jsp" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="images/LOGO1.png" alt="Canvas Logo" ></a>
							...
							<div class="card-body" style="padding: 40px;">
								<form id="login-form" name="login-form" class="nobottommargin" action="login" method="post">
									...
									<div class="col_full">
										...
										<input type="number" id="login-form-username" name="eid" value="" class="form-control not-dark"  required />
									</div>
									...
									<span style="color:red"><%=(request.getAttribute("logoutmessage") == null) ? "" : request.getAttribute("logoutmessage")%></span>
									
									<div class="col_full nobottommargin">
										<button type="submit"  form="login-form" class="button button-3d button-black nomargin" id="login-form-submit" name="login-form-submit" value="login" >Login</button>
										<a href="forgetpass.jsp" class="fright">Forgot Password?</a>
									</div>

									<!-- <div class="col_full nobottommargin">
										<button  type="submit"  class="button button-3d button-black nomargin" id="login-form-submit" name="login-form-submit" value="login"  form="login-form" data-notify-msg="<i class=icon-ok-sign></i> Login Successful!" onclick="SEMICOLON.widget.notifications(this);setTimeout(function() {window.location='#'}, 3000);return false;">Login</button> 
									</div>-->
								</form>
