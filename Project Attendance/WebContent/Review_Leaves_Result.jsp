			...
			<div class="container clearfix">
				 ...
				 <div class="clear"></div><div class="line"></div>
					<div class="col_full center">
						<a href="Review_Leaves.jsp"><button  class="button button-border button-rounded button-fill fill-from-bottom button-black"><i class="fas fa-user-check"></i><span> Click to Approve for Another Date</span></button></a>
						<% if(rs.next()==true){ rs.previous(); %><a href="ApproveAllLeaves"><button  class="button button-border button-rounded button-fill fill-from-bottom button-black"><i class="fas fa-check-circle"></i><span> Click to Approve All Leaves</span></button></a><% }%>
					</div>			
				 <!-- <div class="clear"></div><div class="line"></div> -->
			</div>
